                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="/storage/{{ $item->fotoperusahaan }}" alt="image" width="50" height="50"></td>
                                    <td>{{ $item->status }}</td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="loker/update/{{ $item->id }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <p class="mb-1">Foto</p>
                                                        @if(file_exists("storage/". $item->fotoperusahaan))
                                                        <img src="/storage/{{ $item->fotoperusahaan }}" alt="" width="50" height="50"><br>
                                                        @endif
